...
const ArticleList = () => {
    ...
    return (
        <div className={classes.articlesContainer}>
            ...
            {!articlesLoading && !articlesError && articles.length !== 0 &&<Pagination current={page} onChange={num => setPage(num)} defaultPageSize={5} total={articlesCount - 5} showSizeChanger={false} /> }
        </div>
    )
}
