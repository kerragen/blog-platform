            ...
            <form className={classes.form__main} onSubmit={handleSubmit(onSubmit)}>
                <fieldset className={classes.form__content}>
                    ...
                    <label className={classes.form__item}>
                        Username
                        <input placeholder="Username" className={classes.form__inputOther} {...register('username', {
                    ...
                    <label className={classes.form__item}>
                        Email address
                        <input placeholder="Email address" className={classes.form__inputOther} {...register('email', {
                    ...
                    <label className={classes.form__item}>
                        Repeat password
                        <input placeholder="Password" type="password"  className={classes.form__inputOther} {...register('repeat_password', {
                    ...
                    <Button className={classes.form__button} loading={loading} htmlType='submit' type='primary'>Create</Button>
                    <p className={classes.form__tip}>Already have an account? <Link to='/sign-in' className={classes.form__link}>Sign In.</Link></p>
                </fieldset>
            </form>
        </div>
    )
